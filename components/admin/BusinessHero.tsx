...
export function BusinessHeroDialog() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("page", "business-hub");
    try {
      setLoading(true);
      await apiRequest({
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <DialogHeader>
            ...
            <DialogDescription>
              Add a new hero to your Business-Hub page. Click save when you&apos;re
              done.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4">
            <div className="grid gap-3">
              <Label htmlFor="businesshero-image">Image</Label>
              <Input id="businesshero-image" type="file" name="image" />
            </div>
            <div className="grid gap-3">
              <Label htmlFor="businesshero-title">Title</Label>
              <Input
                id="businesshero-title"
                placeholder="Enter title..."
                name="heading"
              />
            </div>
            <div className="grid gap-3">
              <Label htmlFor="businesshero-description">Description</Label>
              <Input
                id="businesshero-description"
