      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <DialogHeader>
            ...
            <DialogDescription>
              Add a new hero to your Women4tech page. Click save when you&apos;re
              done.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4">
            <div className="grid gap-3">
              <Label htmlFor="whero-image">Image</Label>
              <Input id="whero-image" type="file" name="image" />
            </div>
            <div className="grid gap-3">
              <Label htmlFor="whero-title">Title</Label>
              <Input
                id="whero-title"
            ...
            <div className="grid gap-3">
              <Label htmlFor="whero-description">Description</Label>
              <Input
                id="whero-description"
