...
const Reachout = () => {
  return (
    <section className="mt-12 flex flex-col gap-6 w-full">
      <SubHeading>Reach out to Kuagi Resources Today!</SubHeading>
      <div className="flex flex-col lg:flex-row gap-6 w-full bg-lightblue p-8 lg:px-16">
        {/* Form */}
        ...
        <div className="flex-1 flex flex-col gap-6 items-center justify-stretch">
            ...
            <div className="w-full h-[50%]">
                <Image src={locationData.image} alt="location image" className="w-full object-cover" />
            </div>
        </div>
      </div>
    </section>
